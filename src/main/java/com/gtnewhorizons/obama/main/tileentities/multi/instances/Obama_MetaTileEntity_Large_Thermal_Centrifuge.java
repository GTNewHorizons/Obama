...
public class Obama_MetaTileEntity_Large_Thermal_Centrifuge extends Obama_MetaTileEntity_Factory<Obama_MetaTileEntity_Large_Thermal_Centrifuge> implements IConstructableStructureSliceableCapped {
    public Obama_MetaTileEntity_Large_Thermal_Centrifuge(int aID) {
        super(aID, "multimachine.obama.large_thermal_centrifuge", "Large Thermal Centrifuge");
    }

    public Obama_MetaTileEntity_Large_Thermal_Centrifuge(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Obama_MetaTileEntity_Large_Thermal_Centrifuge(mName);
    }


    private static final ClassValue<IStructureDefinition<Obama_MetaTileEntity_Large_Thermal_Centrifuge>> STRUCTURE_DEFINITION  = new ClassValue<IStructureDefinition<Obama_MetaTileEntity_Large_Thermal_Centrifuge>>() {
        @Override
        protected IStructureDefinition<Obama_MetaTileEntity_Large_Thermal_Centrifuge> computeValue(Class<?> type) {
            return StructureDefinition.<Obama_MetaTileEntity_Large_Thermal_Centrifuge>builder()
    ...
    @Override
    public IStructureDefinition<Obama_MetaTileEntity_Large_Thermal_Centrifuge> getStructureDefinition() {
