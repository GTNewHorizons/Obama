...
import static com.gtnewhorizons.obama.main.tileentities.multi.definition.GeometricInstance.CUBE_3x3x3_WithFunctional;
import static com.gtnewhorizons.obama.main.tileentities.multi.definition.GeometricInstance.CUBE_3x3x3_WithMuffler;
...
public enum DefaultStructureDefinition {
    ...
    public static <T extends GT_MetaTileEntity_EnhancedMultiBlockBase<T> & IAddsBlocks> StructureDefinition.Builder<T> getDefaultStructureDefinitionBuilder(int textureIndex, Block setCasing, int setMeta) {
        return StructureDefinition.<T>builder()
                ...
                .addElement(REQUIRED_ANY_HATCH, ofHatchAdder(
                        GT_MetaTileEntity_EnhancedMultiBlockBase<T>::addToMachineList,
                        textureIndex,
                        1))
                .addElement(INPUT, ofHatchAdder(
                        GT_MetaTileEntity_EnhancedMultiBlockBase<T>::addInputToMachineList,
                        textureIndex,
                        2))
                .addElement(OUTPUT, ofHatchAdder(
                        GT_MetaTileEntity_EnhancedMultiBlockBase<T>::addOutputToMachineList,
                        textureIndex,
                        3))
                .addElement(ENERGY, ofHatchAdder(
                        GT_MetaTileEntity_EnhancedMultiBlockBase<T>::addEnergyInputToMachineList,
                        textureIndex,
                        4))
                .addElement(DYNAMO, ofHatchAdder(
                        GT_MetaTileEntity_EnhancedMultiBlockBase<T>::addDynamoToMachineList,
                        textureIndex,
                        5))
                .addElement(MUFFLER, ofHatchAdder(
                        GT_MetaTileEntity_EnhancedMultiBlockBase<T>::addMufflerToMachineList,
                        textureIndex,
                        6))
                .addElement(MAINTENANCE, ofHatchAdder(
                        GT_MetaTileEntity_EnhancedMultiBlockBase<T>::addMaintenanceToMachineList,
                        textureIndex,
                        7))
    ...
    <T extends GT_MetaTileEntity_EnhancedMultiBlockBase<T> & IAddsBlocks> IStructureDefinition<T> getStructureDefinition(IStructureExpander<T> expander) {
    ...
    public List<String> generateTooltip() {
        ...
        return Stream.of(
                ...
                "For more information use " + EnumChatFormatting.AQUA + "StructLib's Blueprint!",
                TM_MARK
