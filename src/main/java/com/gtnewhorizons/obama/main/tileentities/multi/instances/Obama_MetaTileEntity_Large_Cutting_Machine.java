...
public class Obama_MetaTileEntity_Large_Cutting_Machine extends Obama_MetaTileEntity_Factory<Obama_MetaTileEntity_Large_Cutting_Machine> implements IConstructableStructureSliceableCapped {
    public Obama_MetaTileEntity_Large_Cutting_Machine(int aID) {
        super(aID, "multimachine.obama.large_cutting_machine", "Large Cutting Machine");
    }

    public Obama_MetaTileEntity_Large_Cutting_Machine(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new Obama_MetaTileEntity_Large_Cutting_Machine(mName);
    }


    private static final ClassValue<IStructureDefinition<Obama_MetaTileEntity_Large_Cutting_Machine>> STRUCTURE_DEFINITION  = new ClassValue<IStructureDefinition<Obama_MetaTileEntity_Large_Cutting_Machine>>() {
        @Override
        protected IStructureDefinition<Obama_MetaTileEntity_Large_Cutting_Machine> computeValue(Class<?> type) {
            return StructureDefinition.<Obama_MetaTileEntity_Large_Cutting_Machine>builder()
                ...
                .addElement('P', lazy(t -> ofChain(
                    ofHatchAdder(Obama_MetaTileEntity_Factory::addEnergyInputToMachineList, t.getTextureIndex(), 4),
                    ofBlock(t.getCasingBlock(), t.getCasingMeta()))))
                .addElement('m', lazy(t -> ofHatchAdder(Obama_MetaTileEntity_Factory::addMotorCasingToMachineList, t.getTextureIndex(), 5)))
                .addElement('v', lazy(t -> ofHatchAdder(Obama_MetaTileEntity_Factory::addConveyorCasingToMachineList, t.getTextureIndex(), 6)))
    ...
    @Override
    public IStructureDefinition<Obama_MetaTileEntity_Large_Cutting_Machine> getStructureDefinition() {
