...
public interface IConstructableStructureSliceable extends IConstructableStructureSimple {
    ...
    default boolean checkMachine_TM(IGregTechTileEntity iGregTechTileEntity, ItemStack itemStack) {
        if (!IConstructableStructureSimple.super.checkMachine_TM(iGregTechTileEntity, itemStack))
            return false;
        ...
        setMaxParalells(getStructureCounter() * getParalellsPerSlice() + getMinParallel());
        return true;
    }
