...
public class GT_MetaTileEntitiy_TM_Large_Packager extends GT_MetaTileEntity_TM_Factory implements IConstructableStructureSliceableCapped {
    public GT_MetaTileEntitiy_TM_Large_Packager(int aID) {
        super(aID, "multimachine.tm.large_packager", "Large Packager");
    }

    public GT_MetaTileEntitiy_TM_Large_Packager(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntitiy_TM_Large_Packager(mName);
    }
