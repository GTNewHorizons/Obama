...
public class GT_MetaTileEntitiy_TM_Large_Laser_Engraver extends GT_MetaTileEntity_TM_Factory implements IConstructableStructureSliceable {

    public GT_MetaTileEntitiy_TM_Large_Laser_Engraver(int aID) {
        super(aID, "multimachine.tm.large_precision_laser_engraver", "Large Precision Laser Engraver");
    }

    public GT_MetaTileEntitiy_TM_Large_Laser_Engraver(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntitiy_TM_Large_Laser_Engraver(mName);
    }
