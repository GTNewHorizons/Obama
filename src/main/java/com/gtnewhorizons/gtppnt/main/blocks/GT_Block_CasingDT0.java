...
public class GT_Block_CasingDT0 extends GT_Block_Casings_Abstract {
    public static final byte texturePage = tectechTexturePage1;
    public static final short textureOffset = (texturePage << 7) + 32;//Start of PAGE 8 (which is the 9th page)  (8*128)+32
    private static IIcon[] tM = new IIcon[16];

    public GT_Block_CasingDT0() {
        super(GT_Item_CasingDT0.class, "gt.blockcasingsDT0", GT_Material_Casings.INSTANCE);
        for (byte b = 0; b < 16; b = (byte) (b + 1)) {
            Textures.BlockIcons.casingTexturePages[texturePage][b + 32] = new GT_CopiedBlockTexture(this, 6, b);
            /*IMPORTANT for block recoloring**/
        }

        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".0.name", "Casing 0");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".1.name", "Casing 1");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".2.name", "Casing 2");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".3.name", "Casing 3");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".4.name", "Casing 4");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".5.name", "Casing 5");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".6.name", "Casing 6");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".7.name", "Casing 7");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".8.name", "Casing 8");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".9.name", "Casing 9");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".10.name", "Casing 10");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".11.name", "Casing 11");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".12.name", "Casing 12");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".13.name", "Casing 13");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".14.name", "Casing 14");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".15.name", "Casing 15");
